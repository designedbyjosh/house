    ...
    <>
      ...
      <Container>
        ...
        <div style={{ flex: 4 }} className="grid grid-cols-1 gap-x-5 md:grid-cols-2 my-5 md:">
          <a href={`/photography/${latestPhoto.slug}`} style={{position: 'relative'}} className="bg-neutral-100 dark:bg-neutral-900 mb-5 md:mb-0 hover:opacity-90 cursor-pointer rounded">
          ...
          <div className="bg-neutral-100 dark:bg-neutral-900 mb-5 md:mb-0 p-7 rounded">
