...
const content: React.FC = () => {
  ...
  return (
    <>
      ...
      <Image src={cool_machine} caption={"Figure 1 - The really cool (a.k.a expensive) reflectometer coming in a at a total cost of $10,000 or a measly $3,533.33 per kg"} />
      ...
      Less information equates to more unsurity and greater proximity to the noise floor (random jibberish underlying everything). What's interesting, however, is that the estimation algorithm is actually <b>way more</b> robust to reduced pixel resolution. Reaching as low as 100PPM before we start noticing significant estimation reliability dropsas as shown in Figure 5 below. </p>
      {chartOne}
